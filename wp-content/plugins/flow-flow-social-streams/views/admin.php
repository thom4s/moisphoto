		...
		<a href="http://social-streams.com" target="_blank" class="features"></a>
            ...
            <div class="section-content" data-tab="auth-tab">
                <div class="section" id="auth-settings">
                    ...
                    <p class="desc">Valid to pull any public FB page. <a target="_blank" href="http://social-streams.com/doc/authenticate-with-facebook/">Follow setup guide</a></p>
                    <dl class="section-settings">
                        <dt class="vert-aligned">Access Token</dt>
                        <dd>
                    ...
                    <p class="desc">Valid to pull any public Instagram account feed or valid search term. <a target="_blank" href="http://social-streams.com/doc/authenticate-with-instagram">Follow setup guide</a></p>
                    <dl class="section-settings">
                        <dt class="vert-aligned">Access Token</dt>
                        <dd>
